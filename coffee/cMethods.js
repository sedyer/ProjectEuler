...
(function() {
  var comparator, findPythagoreanTripletWithGivenSum, getAllFactorPairs, getTriplet, getTripletsFromFactorPairs, getUniqueElements, getUniqueFactorPairs, getValidTriplets, isFactor, isPrime, sortTuples, sumAllPrimesUnderValue;
  ...
  isPrime = function(num) {
    ...
    vals = Array.from(new Array(Math.ceil(Math.sqrt(num))), function(x, i) {
      return i + 2;
    });
